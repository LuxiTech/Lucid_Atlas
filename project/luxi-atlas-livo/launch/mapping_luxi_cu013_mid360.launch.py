...
def generate_launch_description():
    ...
    rviz_config_file = os.path.join(package_share_dir, "rviz_cfg", "fast_livo2.rviz")

    livo_config_file = os.path.join(config_dir, "luxi", "luxi_cu013_mid360.yaml")
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="FAST-LIVO2 parameters for Luxi CU013 + MID360.",
        ),
        DeclareLaunchArgument(
            "camera_params_file",
