...
def generate_launch_description():
    ...
    declare_contact_sensor = DeclareLaunchArgument(
        "contact_sensor", default_value="False", description="Publish contact sensor data"
    )
    ...
    start_gazebo_server_paused_cmd = ExecuteProcess(
    ...
    start_gazebo_client_delayed = TimerAction(
        period=12.0, actions=[start_gazebo_client_cmd]
    )
    ...
    contact_sensor = Node(
        ...
        condition=IfCondition(LaunchConfiguration("contact_sensor")),
    ...
    return LaunchDescription(
        [
            ...
            start_gazebo_server_paused_cmd,
            start_gazebo_client_delayed,
